...
```
git clone https://github.com/siyuanwu99/oh-my-tmux.git ~/.config/tmux
mv "/home/$USER/.config/tmux/.tmux.conf" "/home/$USER/.config/tmux/tmux.conf"
mv "/home/$USER/.config/tmux/.tmux.conf.local" "/home/$USER/.config/tmux/tmux.conf.local"
```
